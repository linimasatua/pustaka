...
async function connect02() {
    process02 = exec('node root.js '+(SIZE+2)+' '+EXTRA)
...
async function connect03() {
    process03 = exec('node root.js '+(SIZE+3)+' '+EXTRA)
...
async function connect04() {
    process04 = exec('node root.js '+(SIZE+4)+' '+EXTRA)
...
async function connect05() {
    process05 = exec('node root.js '+(SIZE+5)+' '+EXTRA)
